...
import Select from 'components/ui/Select'; // Assuming a Select component is available

const CheckoutStepOne = ({ formData, handleCountryChange,handleInputChange, handleNext, isFormComplete }) => {
    ...
    >
      ...
      >
        <div className="flex items-center mb-4 sm:mb-6">
          ...
          <h3 className="text-base sm:text-lg font-semibold text-gray-900">Terms & Preferences</h3>
        </div>
